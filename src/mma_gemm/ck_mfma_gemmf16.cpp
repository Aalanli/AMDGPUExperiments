                               ...
                               const Problem& problem)
    {
        ...
        auto a_blockwise_copy =
            ThreadGroupTensorSliceTransfer_v4r1<ThisThreadBlock,
                                                ...
                                                Sequence<AK0Number, MPerBlock, AK1Number>, // [4, 256, 8]
                                                ABlockTransferThreadClusterLengths_AK0_M_AK1, // [4, 64, 1]
        ...
        b_blockwise_copy.RunRead(b_grid_desc_bk0_n_bk1, b_grid_buf);

        a_blockwise_copy.MoveSrcSliceWindow(a_grid_desc_ak0_m_ak1, a_block_slice_copy_step);
        b_blockwise_copy.MoveSrcSliceWindow(b_grid_desc_bk0_n_bk1, b_block_slice_copy_step);

        // Initialize C
        c_thread_buf.Clear();

        a_blockwise_copy.RunWrite(a_block_desc_ak0_m_ak1, a_block_buf);
        b_blockwise_copy.RunWrite(b_block_desc_bk0_n_bk1, b_block_buf);

        // main body
        index_t num_loop = num_k_block_main_loop;
        index_t i = 0;
