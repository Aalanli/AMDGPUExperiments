...
hand_picked_configs = [
    ...
    KernelConfig({'BlockM': 64, 'BlockK': 32, 'BlockN': 128, 'TM': 4, 'TN': 4, 'TK': 2, 'ThreadM': 2, 'ThreadK': 1, 'ThreadN': 16, 'WarpM': 4, 'WarpN': 2, 'TYPE': 'float'}),
...
kernel_simtv4 = KernelHandler(
    source_file='src/simt_gemm/simt_gemmv4.cu',
...
def simt_gemmv4(a: torch.Tensor, b: torch.Tensor) -> torch.Tensor:
    ...
    kernel_simtv4(a, b, c, m=m, k=k, n=n)
    return c
